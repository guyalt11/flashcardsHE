  ...
  if (!currentList || (practiceWords.length === 0 && initialWordsRef.current.length === 0)) {
    return (
      <div className="container py-6 max-w-3xl flex flex-col items-center">
        ...
        <Button onClick={() => onDirectionChange(direction === 'hebrewToEnglish' ? 'englishToHebrew' : 'hebrewToEnglish')}>
          Try {direction === 'hebrewToEnglish' ? 'English to Hebrew' : 'Hebrew to English'}
        </Button>
