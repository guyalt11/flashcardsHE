...
export type PracticeDirection = 'hebrewToEnglish' | 'englishToHebrew';
...
export interface VocabWord {
  ...
  lastPracticed?: {
    hebrewToEnglish?: Date;
    englishToHebrew?: Date;
  };
  nextReview?: {
    hebrewToEnglish?: Date;
    englishToHebrew?: Date;
  ...
  difficulty?: {
    hebrewToEnglish?: DifficultyLevel;
    englishToHebrew?: DifficultyLevel;
  };
  
  // SM-2 parameters for each direction
  sm2?: {
    hebrewToEnglish?: SM2Params;
    englishToHebrew?: SM2Params;
  };
}
...
export const DIRECTION_MULTIPLIERS: Record<PracticeDirection, number> = {
  hebrewToEnglish: 1.0, // Same multiplier
  englishToHebrew: 1.0, // Same multiplier
};
